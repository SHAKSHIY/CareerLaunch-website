...
const MyJobs = () => {
    const email = "shakshi0803@gmail.com"
    ...
    useEffect(() => {
        setIsLoading(true)
        fetch(`http://localhost:3000/myJobs/shakshi0803@gmail.com`).then(res => res.json()).then(data => {
            setJobs(data);
            setIsLoading(false);
        })
    }, [searchText])
        ...
        <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
            <div className='my-jobs-container'>
                ...
                <div className='search-box p-2 text-center mb-2'>
                    ...
                    <button className='bg-purple-600 text-white font-semibold px-8 py-2 rounded-sm mb-4' onClick={handleSearch}>Search</button>
                </div>
            </div>
                        ...
                        <div className="rounded-t mb-0 px-4 py-3 border-0">
                            <div className="flex flex-wrap items-center">
                                ...
                                <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                                    <Link to="/post-job"><button className="bg-purple-600 text-white active:bg-purple-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Post a New Job</button></Link>
                                </div>
                            </div>
                        </div>
